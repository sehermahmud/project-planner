...
var _default = /*#__PURE__*/function () {
  function _default(hostElementId) {
...
var Tooltip = /*#__PURE__*/function (_Cmp) {
  _inherits(Tooltip, _Cmp);

  var _super = _createSuper(Tooltip);

  function Tooltip(closeNotifierFunction, text, hostElementId) {
    var _this;

    _classCallCheck(this, Tooltip);

    _this = _super.call(this, hostElementId);
  ...
  _createClass(Tooltip, [{
    ...
    value: function create() {
      ...
      var hostElPosLeft = this.hostElement.offsetLeft;
      var hostElPosTop = this.hostElement.offsetTop;
      var hostElHeight = this.hostElement.clientHeight;
      var parentElementScrolling = this.hostElement.parentElement.scrollTop;
      var x = hostElPosLeft + 20;
      var y = hostElPosTop + hostElHeight - parentElementScrolling - 10;
